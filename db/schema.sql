...
CREATE TABLE events (id INTEGER PRIMARY KEY AUTOINCREMENT, name text, dateParts text, timeParts text, longDesc text, shortDesc text, website text, contactName text, phone text, location text, addressType text, address text, city text, state text, zip text, borough text, user_id integer);
